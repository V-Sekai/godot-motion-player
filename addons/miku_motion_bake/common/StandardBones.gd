...
func _init():
	...
	for group in finger_bone_groups:
		var finger_group = [StandardBone.new(group[1], group[0], group[4], group[4]), StandardBone.new(group[2], group[1], group[5], group[5]), StandardBone.new(group[3], group[2], group[6], group[6])]
